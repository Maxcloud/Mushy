...
var ditems = Array("#v5211067#1.2x EXP Card (1 Day)", "#v5211068#1.5x EXP Card (1 Day)", "#v5360000#2x Drop/Meso Card (1 Day)", "#v4030004#Clone (1 Day, Untradeable)", "#v5680021#Chair Gachapon Tix");
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            cm.sendYesNo("Once you proceed with this selection, you can't go back! Are you sure you want Additional Pendant Slot (7 Days) for 20 Vote Points? After Completion, make sure to relog so it takes effect! ");
        } else if (selection == 3) {
