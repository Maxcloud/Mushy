...
//    }
 ...
 //               return 20040220;
        ...
        switch (skillid) {
            case 20041226: // Ã¬Å Â¤Ã­Å½â„¢Ã­Å Â¸Ã«Å¸Â´ Ã«ï¿½Â¼Ã¬ï¿½Â´Ã­Å Â¸ (ÃªÂ¸Â°Ã«Â³Â¸ Ã¬Â§ï¿½Ã¬â€”â€¦)
            case 27001100: // Ã­Å Â¸Ã¬Å“â„¢Ã­ï¿½Â´ Ã­â€�Å’Ã«Å¾ËœÃ¬â€°Â¬
    ...
    public static final int getLinkedAttackSkill(final int id) {
        switch (id) {
            ...
            case 35121011:
                return 35121009;
            case 35111009:
            case 35111010: //Ã¬Æ’Ë†Ã­â€¹â‚¬Ã«ï¿½Â¼Ã¬ï¿½Â´Ã­Å Â¸
                return 35111001;
            case 35100004:
                return 35101004;
            case 32001007:
            ...
            case 31001008:
                return 31000004;
            case 27120211:
                return 27121201; //Ã«ÂªÂ¨Ã«â€¹ï¿½ Ã¬Å Â¤Ã­Æ’â‚¬Ã­ï¿½Â´
            case 61001004:
            case 61001005:
            case 61110212:
            case 61120219:
                return 61001000; //Ã«â€œÅ“Ã«Å¾ËœÃªÂ³Â¤Ã¬Å Â¬Ã«Å¾ËœÃ¬â€¹Å“
            case 61110211:
            case 61120007:
            case 61121217:
                return 61101002; //Ã¬Å“Å’Ã¬ËœÂ¤Ã«Â¸Å’Ã¬â€ Å’Ã«â€œÅ“
            case 61111215:
                return 61001101; // Ã­â€�Å’Ã«Â Ë†Ã¬Å¾â€ž Ã¬Æ’Â·
            case 61111217:
                return 61101101; // Ã­â€�Â¼Ã¬â€“Â´Ã¬Å Â¤ Ã«Å¸Â¬Ã¬â€°Â¬
            case 61111216:
                return 61101100; // Ã¬Å¾â€žÃ­Å’Â©Ã­Å Â¸ Ã¬â€ºÂ¨Ã¬ï¿½Â´Ã«Â¸Å’
            case 61111219:
                return 61111101; // Ã¬Â²Â´Ã¬ï¿½Â¸Ã­â€™â‚¬Ã«Â§ï¿½
            case 61111113:
            case 61111218:
                return 61111100; //Ã¬Å“â„¢Ã«Â¹â€žÃ­Å Â¸ - Ã¬Â»Â¤Ã«Â§Â¨Ã«â€œÅ“
            case 61121201:
                return 61121100; //ÃªÂ¸Â°ÃªÂ°â‚¬Ã¬Å Â¬Ã«Å¾ËœÃ¬â€¦â€�
            case 61121203:
                return 61121102; //Ã«Â¸â€�Ã«Â£Â¨Ã¬Å Â¤Ã­Å Â¸Ã«Â¦Â­
            case 61110009:
                return 61111003; //Ã«Â¦Â¬ÃªÂ²Å’Ã¬ï¿½Â¸ Ã¬Å Â¤Ã­Å Â¸Ã«Â ï¿½Ã¬Å Â¤
            /*case 61121217:
             return 61120007; //Ã¬â€“Â´Ã«â€œÅ“Ã«Â°Â´Ã¬Å Â¤Ã«â€œÅ“ Ã¬â€ºâ€�Ã¬ËœÂ¤Ã«Â¸Å’Ã¬â€ Å’Ã«â€œÅ“*/
            case 61121116:
                return 61121104; //Ã¬â€ Å’Ã«â€œÅ“Ã¬Å Â¤Ã­Å Â¸Ã«ï¿½Â¼Ã¬ï¿½Â´Ã­ï¿½Â¬ - Ã­ï¿½Â­Ã­Å’â€�
            case 61121223:
                return 61121221; //Ã¬â€ Å’Ã«â€œÅ“ Ã¬Å Â¤Ã­Å Â¸Ã«ï¿½Â¼Ã¬ï¿½Â´Ã­ï¿½Â¬ - Ã­ï¿½Â­Ã­Å’â€�
            case 61121221:
                return 61121104; // Ã¬â€ Å’Ã«â€œÅ“ Ã¬Å Â¤Ã­Å Â¸Ã«ï¿½Â¼Ã¬ï¿½Â´Ã­ï¿½Â¬
            case 65101006:
                return 65101106;
            case 65121007:
            case 65121008:
                return 65121101;
            case 61111220:
                return 61121105; // Ã¬ï¿½Â¸Ã­ï¿½Â¼Ã«â€žï¿½ Ã«Â¸Å’Ã«Â Ë†Ã¬Å Â¤
            //case 61120018:
            //      return 61121105;
            //Ã¬Â¹Â´Ã¬ï¿½Â´Ã¬Â â‚¬Ã«ï¿½ï¿½
            case 65111007: //Ã¬â€ Å’Ã¬Å¡Â¸ Ã¬â€¹Å“Ã¬Â»Â¤
                return 65111100;
            case 4100012: //Ã«Â§Ë†Ã­ï¿½Â¬ Ã¬ËœÂ¤Ã«Â¸Å’ Ã¬â€“Â´Ã¬Å’â€�Ã¬â€¹Â 
                return 4100011;
            case 24121010:
                return 24121003;
            case 24111008:
            ...
            case 25120003:
                return 25121000;
            case 95001000:
                return 3111013; // Ã¬â€¢Â Ã«Â¡Å“Ã¬Å¡Â° Ã­â€�Å’Ã«Å¾ËœÃ­â€žÂ°
            case 4210014: //Ã«Â©â€�Ã¬â€ Å’ Ã¬ï¿½ÂµÃ¬Å Â¤Ã­â€�Å’Ã«Â¡Å“Ã¬Â Â¼
                return 4211006;
            case 101000102: //Ã¬â€“Â´Ã«â€œÅ“Ã«Â°Â´Ã¬Å Â¤Ã«â€œÅ“ Ã­Å’Å’Ã¬â€ºÅ’ Ã¬Å Â¤Ã­â€¦â‚¬Ã­â€�â€ž(Ã¬Â¶Â©ÃªÂ²Â©Ã­Å’Å’) 
                return 101000101;
            // Ã«â€šËœÃ¬â€ºÅ’ Ã¬â€¹Å“Ã¬Å¾â€˜
            case 14101021:
                return 14101020; // Ã­Å Â¸Ã«Â¦Â¬Ã­â€�Å’ Ã¬Å Â¤Ã«Â¡Å“Ã¬Å¡Â°
            case 14111021:
                return 14111020; // Ã¬Â¿Â¼Ã«â€œÅ“Ã«Å¸Â¬Ã­â€�Å’ Ã¬Å Â¤Ã«Â¡Å“Ã¬Å¡Â°
            case 14111023:
                return 14111022; // Ã¬Å Â¤Ã­Æ’â‚¬Ã«ï¿½â€�Ã¬Å Â¤Ã­Å Â¸
            case 14121002:
                return 14121001; // Ã­â‚¬Â¸Ã­â€žÂ°Ã­â€�Å’ Ã¬Å Â¤Ã«Â¡Å“Ã¬Å¡Â°
            // Ã«â€šËœÃ¬â€ºÅ’ Ã«ï¿½ï¿½
            //Ã­â€�Å’Ã¬Å“â€ž Ã¬â€¹Å“Ã¬Å¾â€˜
            case 12120011:
                return 12121001;
            case 12120012:
                return 12121003;
...
//        System.out.println(getSkillBook(skillid / 10000));
    ...
    public static int getLinkedMountItem(int sourceid) {
        ...
        switch (sourceid) {
            case 1204: // Ã«Â°Â°Ã­â€¹â‚¬Ã¬â€°Â½
                return riding + 0;
            case 80001163: // Ã¬Å Â¤Ã­Å½ËœÃ¬ï¿½Â´Ã¬Å Â¤Ã¬â€°Â½
                return riding + 2;
            case 80001449: // Ã¬Å Â¤Ã­Å½ËœÃ¬ï¿½Â´Ã¬Å Â¤Ã¬â€°Â½2
                return riding + 225;
            case 80001450: // Ã¬ËœÂ¤Ã­â€ Â Ã«Â°â€�Ã¬ï¿½Â´2
                return riding + 226;
            case 80001451: // Ã¬Å Ë†Ã­Å Â¸2
                return riding + 227;
            case 80001026: // Ã«Â¹â€”Ã¬Å¾ï¿½Ã«Â£Â¨ ok
                return riding + 5;
            case 80001003: // Ã«ÂªÂ©Ã«Â§Ë† ok
                return riding + 6;
            case 80001004: // Ã¬â€¢â€¦Ã¬â€“Â´ ok
                return riding + 7;
            case 80001005: // Ã¬ËœÂ¤Ã­â€ Â Ã«Â°â€�Ã¬ï¿½Â´ (ÃªÂ°Ë†Ã¬Æ’â€°) ok
                return riding + 8;
            case 80001006: // Ã¬ËœÂ¤Ã­â€ Â Ã«Â°â€�Ã¬ï¿½Â´ (Ã«Â¶â€žÃ­â„¢ï¿½Ã¬Æ’â€°) ok
                return riding + 9;
            case 80001007: // ÃªÂµÂ¬Ã«Â¦â€ž ok
                return riding + 11;
            case 80001008: // Ã¬Â§â€žÃ¬Â§Å“ Ã«Â°Å“Ã«Â¡ï¿½ ok
                return riding + 10;
            case 80001009: // Ã«Â Ë†Ã¬ï¿½Â´Ã¬â€¹Â±Ã¬Â¹Â´ ok
                return riding + 13;
            case 80001010: // Ã­â€�Â¼Ã¬â€¹Å“Ã«Â°Â© Ã­ËœÂ¸Ã«Å¾â€˜Ã¬ï¿½Â´ ok
                return riding + 14;
            case 80001011: // Ã«Â¯Â¸Ã¬Å Â¤Ã­Å Â¸ Ã«Â°Å“Ã«Â¡ï¿½ (Ã¬Â â€žÃ¬Â²Â´Ã«ÂªÂ¨Ã¬Å Âµ) ok
                return riding + 12;
            case 80001013: // Ã¬Â£Â¼Ã­â„¢Â©Ã«Â²â€žÃ¬â€žÂ¯ ok
                return riding + 23;
            case 80001014: // Ã«Â¶Ë†Ã­Æ’â‚¬Ã«Å â€� Ã«Â§ï¿½ ok
                return riding + 25;
            case 80001015: // Ã­Æ’â‚¬Ã¬Â¡Â° ok
                return riding + 26;
            case 80001016: // Ã­â€¢â€˜Ã­ï¿½Â¬ÃªÂ³Â° Ã¬â€”Â´ÃªÂ¸Â°ÃªÂµÂ¬ ok
                return riding + 27;
            case 80001017: // Ã­Å’Å’Ã«Å¾â€˜ Ã«Â¡Å“Ã«Â´â€¡ ok
                return riding + 28;
            case 80001018: // Ã¬ËœÂ¤Ã­â€ Â Ã«Â°â€�Ã¬ï¿½Â´ (Ã«Â¹Â¨ÃªÂ°â€¢Ã¬Æ’â€°) ok
                return riding + 34;
            case 80001019: // Ã­Å’Å’Ã¬â€ºÅ’Ã«â€œÅ“ Ã¬Å Ë†Ã­Å Â¸ ok
                return riding + 35;
            case 80001020: // Ã«ï¿½Â¼Ã¬ï¿½Â´Ã¬â€“Â¸Ã­â€šÂ¹ ok
                return riding + 41;
            case 80001021: // Ã«Â¸â€�Ã«Â£Â¨ Ã¬Å Â¤Ã¬Â¿Â Ã«ï¿½â€� ok
                return riding + 43;
            case 80001022: // Ã«Â£Â¨Ã«ï¿½Å’Ã­â€˜Â¸ ÃªÂ°Å“Ã¬â€šï¿½Ã«Å’â‚¬ ok
                return riding + 44;
            case 80001023: // Ã«Â³ÂµÃ¬Â£Â¼Ã«Â¨Â¸Ã«â€¹Ë† ok
                return riding + 48;
            case 80001027: // Ã«â€šËœÃ«Â¬Â´ Ã«Â¹â€žÃ­â€“â€°ÃªÂ¸Â° ok
                return riding + 49;
            case 80001028: // Ã«Â¹Â¨ÃªÂ°â€ž Ã«Â¹â€žÃ­â€“â€°ÃªÂ¸Â° ok
                return riding + 50;
            case 80001038: // Ã­â„¢Â©ÃªÂ¸Ë† Ã¬Å¾Â¥Ã¬â€¹ï¿½ Ã«Â°Â° ok
                return riding + 53;
            case 80001030: // Ã«â€¹Â­ ok
                return riding + 54;
            case 80001031: // Ã«Â¶â‚¬Ã¬â€”â€°Ã¬ï¿½Â´ ok
                return riding + 55;
            case 80001032: // Ã­Å’Å’Ã«Å¾â€˜ Ã¬Å¾ï¿½Ã«ï¿½â„¢Ã¬Â°Â¨ ok
                return riding + 56;
            case 80001033: // Ã¬Â¹Â´Ã«â€¹Ë†Ã«Â°Å“ Ã«ï¿½Â¼Ã¬ï¿½Â´Ã«â€�Â© ok
                return riding + 57;
            case 80001044: // ÃªÂ¼Â¬Ã«Â§Ë†Ã­â€ Â ÃªÂ¸Â° ok
                return riding + 90;
            case 80001082: // Ã­â„¢Â©Ã¬â€ Å’ ok
                return riding + 93;
            case 80001083: // Ã¬Ë†ËœÃ«Â Ë†ÃªÂ¾Â¼Ã­â€ Â Ã«ï¿½Â¼ ok
                return riding + 94;
            case 80001084: // Ã¬â€¹Å“Ã«Â°Å“Ã«Â¬Â´Ã¬â€žÅ“Ã¬Å¡Â´Ã­â€ Â Ã«ï¿½Â¼ ok
                return riding + 95;
            case 80001090: // Ã¬Â¶â€�Ã¬Å¾Â¥Ã«Â©Â§Ã«ï¿½Â¼Ã¬Â§â‚¬ ok
                return riding + 96;
            case 80001137: // ÃªÂ²â‚¬Ã¬ï¿½â‚¬Ã«Â¶â‚¬Ã¬â€”â€°Ã¬ï¿½Â´ ok
                return riding + 110;
            case 80001144: // Ã«Â¥ËœÃ­ËœÂ¸Ã¬Ë†ËœÃ«Â Ë†ÃªÂ¾Â¼ ok
                return riding + 113;
            case 80001148: // Ã«Â¹Â¨ÃªÂ°â€žÃ«Â¶â€¢Ã«Â¶â€¢Ã¬Â°Â¨ ok
                return riding + 114;
            case 80001149: // Ã«Â©â€¹Ã¬Â§â€ž Ã«Â¡Å“Ã«Â´â€¡ ok
                return riding + 115;
            case 80001198: // Ã«â€œÅ“Ã«Å¾ËœÃªÂ³Â Ã«â€¹Ë†Ã¬Â¹Â´ ok
                return riding + 140;
            case 80001220: // Ã­Å’Â¬Ã­â€¦â‚¬ ok
                return riding + 143;
            case 80001221: // Ã¬â€¢â€žÃ«Â¦Â¬Ã¬â€¢â€ž ok
                return riding + 144;
            case 80001228: // Ã¬Å¾Â¬ÃªÂ·Å“Ã¬â€“Â´ ok
                return riding + 148;
            case 80001237: // Ã«Â¸â€�Ã«Å¾â„¢Ã¬â„¢â‚¬Ã¬ï¿½Â´Ã«Â²Ë† ok
                return riding + 153;
            case 80001243: // Ã¬â„¢Â¸Ã«Â°Å“Ã¬Å¾ï¿½Ã¬Â â€žÃªÂ±Â° ok
                return riding + 156;
            case 80001244: // ÃªÂ²Â¨Ã¬Å¡Â¸Ã¬â„¢â€¢ÃªÂµÂ­ ok
                return riding + 157;
            case 80001246: // Ã«â€¹Â¬ ok
                return riding + 159;
            case 80001257: // Ã­â€¢â€˜Ã­ï¿½Â¬Ã«Â¹Ë† Ã«â€˜Â¥Ã«â€˜Â¥ ok
                return riding + 161;
            case 80001258: // Ã«Â¸â€�Ã«Å¾â„¢Ã«Â¹Ë† Ã«â€˜Â¥Ã«â€˜Â¥ ok
                return riding + 162;
            case 80001261: // Ã¬â€“Â´Ã«â€“Â¤ Ã¬ï¿½Â´Ã¬Æ’ï¿½Ã­â€¢Å“Ã«â€¦â€ž ok
                return riding + 164;
            case 80001285: // Ã­â€™ï¿½Ã¬â€žÂ  Ã«â€˜Â¥Ã«â€˜Â¥ ok
                return riding + 167;
            case 80001289: // Ã«ï¿½Â°Ã«Â¹â€žÃ¬Â¡Â´ ok
                return riding + 170;
            case 80001290: // Ã¬â€¹Â Ã«Â¹â€žÃ«ÂªÂ©Ã«Â§Ë† ok
                return riding + 171;
            case 80001292: // Ã¬â€“Â´Ã«Â¦Â°Ã¬â„¢â€¢Ã¬Å¾ï¿½ ok
                return riding + 173;
            case 80001302: // ÃªÂ²â‚¬Ã¬ï¿½â‚¬ Ã«â€œÅ“Ã«Å¾ËœÃªÂ³Â¤ ok
                return riding + 178;
            case 80001304: // Ã«Â©Â§Ã«ï¿½Â¼Ã¬Â§â‚¬ ok
                return riding + 179;
            case 80001305: // Ã¬ï¿½â‚¬Ã«Â¹â€ºÃªÂ°Ë†ÃªÂ¸Â° ok
                return riding + 180;
            case 80001306: // Ã«Â Ë†Ã«â€œÅ“ Ã«â€œÅ“Ã«ï¿½Â¼Ã¬Â½â€� ok
                return riding + 181;
            case 80001307: // Ã­â€¹Â°Ã­â€¹Â°Ã¬â€¢â€žÃ«â€šËœ ok
                return riding + 182;
            case 80001308: // Ã­â€¹Â°Ã­â€¹Â°Ã¬ËœÂ¤ ok
                return riding + 183;
            case 80001309: // Ã¬â€¹Â Ã¬Â¡Â° ok
                return riding + 184;
            case 80001312: // Ã«Â¥ËœÃ­ËœÂ¸ 1 ok
                return riding + 187;
            case 80001313: // Ã«Â¥ËœÃ­ËœÂ¸ 2 ok
                return riding + 188;
            case 80001314: // Ã«Â¥ËœÃ­ËœÂ¸ 3 ok
                return riding + 189;
            case 80001315: // Ã«Â¥ËœÃ­ËœÂ¸ 4 ok
                return riding + 190;
            case 80001316: // Ã¬â€”ï¿½Ã«Â°Ëœ 1 ok
                return riding + 191;
            case 80001317: // Ã¬â€”ï¿½Ã«Â°Ëœ 2 ok
                return riding + 192;
            case 80001318: // Ã¬â€”ï¿½Ã«Â°Ëœ 3 ok
                return riding + 193;
            case 80001319: // Ã­â€¢ËœÃ¬ï¿½Â´Ã¬â€”ï¿½Ã«â€šËœ ok
                return riding + 194;
            case 80001327: // Ã«ï¿½â€¢Ã«ï¿½â€¢ ok
                return riding + 198;
            case 80001331: // Ã«Â³Â´Ã¬â€žï¿½ Ã¬â€žÂ¹Ã¬Å Â¤ ok
                return riding + 199;
            case 80001336: // Ã­â€¢ËœÃ¬â€“â‚¬Ã«Â³â€˜Ã¬â€¢â€žÃ«Â¦Â¬ ok
                return riding + 200;
            case 80001338: // Ã¬Å¾Â¥Ã«â€šÅ“ÃªÂ°ï¿½ ok
                return riding + 201;
            case 80001333: // Ã«Â¹Â¨ÃªÂ°â€žÃªÂ·Â¼Ã«â€˜ï¿½Ã¬Å¡Â´ ok
                return riding + 205;
            case 80001347: // Ã¬â€¢â€¦Ã«Â§Ë†Ã«â€¦â€ž ok
                return riding + 207;
            case 80001348: // Ã­Å¾â„¢Ã­â€¢Â© ok
                return riding + 208;
            case 80001353: // Ã¬â€¢â€¦Ã«Â§Ë†Ã«â€¦â€ž2 ok
                return riding + 211;
            case 80001413: // Ã¬Å¸ï¿½Ã«Â°Ëœ ok
                return riding + 219;
            case 80001421: // Ã«Â§Ë†Ã¬Â°Â¨ ok
                return riding + 221;
            case 80001423: // Ã«Â²Â¨Ã«Â£Â¸ ok
                return riding + 222;
            case 80001445: // Ã«Â¹â€ºÃ«â€šÂ ÃªÂ°Å“ ok
                return riding + 242;
            case 80001447: // Ã¬â€“Â´Ã«â€˜Â Ã«â€šÂ ÃªÂ°Å“ ok
                return riding + 243;
            case 80001484: // Ã«Â¶â‚¬Ã¬Â¸Â  ok
                return riding + 235;
            case 80001508: // Ã¬â€“Â¼Ã¬ï¿½Å’Ã«Â§ï¿½ ok
                return riding + 244;
            case 80001345:// Ã­â€”Â¤Ã¬Â¹Â´Ã­â€ Â¤Ã¬Â£Â¼Ã«Â¨Â¹
                return riding + 204;
            case 80001199:// Ã«ï¿½â€¦Ã¬Ë†ËœÃ¬Å“Â¼Ã«Â¦Â¬ Ã«Å’â‚¬Ã¬Â²Ëœ
                return riding + 256;
            case 80001490: // Ã«â€šËœÃ¬Å“Â¼Ã«Â¦Â¬ Ã«Å’â‚¬Ã¬Â²Ëœ
                return riding + 259;
            case 80001491: // Ã­â€”Â¬Ã«Â¦Â¬Ã¬Â½Â¥Ã­â€žÂ° Ã«Å’â‚¬Ã¬Â²Ëœ
                return riding + 258;
            case 80001505: // Ã¬Â§â‚¬ÃªÂ°ï¿½Ã­â€“Ë†Ã«â€¹Â¹   
                return riding + 251;
            case 80001492: // ÃªÂ¿â‚¬ÃªÂ¿â‚¬Ã«â€šËœÃ«Â¹â€ž     
                return riding + 249;
            case 80001503: // Ã­Ë†Â¬Ã«Âªâ€¦Ã«Â°Å“Ã«Â¡ï¿½
                return riding + 12;
            case 80001531: //Ã¬ï¿½Â´Ã¬Æ’ï¿½Ã­â€¢Å“Ã«Â§ï¿½
                return riding + 253;
            case 80001549: //Ã«Â©â€�Ã¬ï¿½Â´Ã­â€�Å’Ã¬Â°Â¨?
                return riding + 254;
            case 80001550: //Ã­Å’Â¬Ã«ï¿½â€�
                return riding + 255;
            case 80001355://Ã«ï¿½Å’ÃªÂ³Â Ã«Å¾Ëœ    
                return riding + 212;
            case 80001411://Ã¬Â¢â‚¬Ã«Â¹â€žÃ­Å Â¸Ã«Å¸Â­
                return riding + 218;
            /*case 80001552: //Ã«ï¿½â€¦Ã¬Ë†ËœÃ¬Å“Â¼Ã«Â¦Â¬
             case 80001553:    
             return + 256;
             case 80001554: //Ã­â€”Â¬Ã«Â¦Â¬Ã¬Â½Â¥Ã­â€žÂ°?
             case 80001555:
             return + 258;
             /* case 80001557://Ã«â€šËœÃ¬Å“Â¼Ã«Â¦Â¬
             case 80001558:    
             return + 259;*/
            default:
                return 0;
