...
public enum RecvPacketOpcode {
	...
	SPOUSE_CHAT(0x12A),
	MESSENGER(0x12B),
	PLAYER_INTERACTION(0x183),
	PARTY_OPERATION(0x184),
	DENY_PARTY_REQUEST(0x185),
	ALLOW_PARTY_INVITE(0x186),
