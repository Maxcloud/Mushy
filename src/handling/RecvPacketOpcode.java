...
public enum RecvPacketOpcode {
	...
	REQUEST_FAMILY(0x999),
	OPEN_FAMILY(0x13E),
	FAMILY_OPERATION(0x13F),
	DELETE_JUNIOR(0x140),
	DELETE_SENIOR(0x141),
	ACCEPT_FAMILY(0x142),
	USE_FAMILY(0x143),
	FAMILY_PRECEPT(0x999), // 0x144
	FAMILY_SUMMON(0x145),
	BBS_OPERATION(0x150),
	SOLOMON_EXP(0x151),
	NEW_YEAR_CARD(0x11E),
