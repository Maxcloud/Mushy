...
public enum RecvPacketOpcode {
	...
	// +8
	MOVE_LIFE(0x339), // 0x208
	AUTO_AGGRO(0x342), // 0x1EE
	FRIENDLY_DAMAGE(0x343), // ..
	MONSTER_BOMB(0x344), // 0x1F0
	HYPNOTIZE_DMG(0x345), // 0x1F1
	MOB_BOMB(0x1F5),
	MOB_NODE(0x1F6),
	DISPLAY_NODE(0x1F7),
	MONSTER_CARNIVAL(0x1F8),
	NPC_ACTION(0x353), // 0x222
	ITEM_PICKUP(0x358), // 0x227
	DAMAGE_REACTOR(0x35B), // 0x22A
	TOUCH_REACTOR(0x22B),
	CLICK_REACTOR(0x22C),
