...
public class MapScriptMethods {
    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case mCastle_enter:
                c.getSession().write(CField.showMapEffect("event/mCastle"));
                break;
...
//                int ad = Integer.parseInt(lol);
            ...
            case pierre_Summon: {
             ...
             //       c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(8900000), new Point(497, 551));
                    ...
                    c.getSession().write(CField.showMapEffect("rootabyss/firework"));
            ...
            case killing_BonusSetting: { //spawns monsters according to mapid
                ...
                c.getPlayer().getMap().resetFully();
                c.getSession().write(CField.showMapEffect("killing/bonus/bonus"));
                c.getSession().write(CField.showMapEffect("killing/bonus/stage"));
...
//                    Thread.sleep(6000);
            ...
            case Advanture_tuto02: {
                try {
                    c.getSession().write(UIPacket.getDirectionStatus(true));
                    c.getSession().write(UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.showEnterEffect("demonSlayer/whiteOut"));
...
//                try {
                    c.getSession().write(UIPacket.getDirectionStatus(true));
                    c.getSession().write(UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.showEnterEffect("maplemap/enter/10000"));
                    NPCScriptManager.getInstance().dispose(c);
                    c.removeClickedNPC();
...
//                }
            ...
            case sao_enterRewardMap: {
                    c.getSession().write(CField.showMapEffect("Sao/Start1"));
           //         c.getPlayer().getMap().startMapEffect("Attempt to wake the Crimson Queen", 5120107);
                 break;
            }
            
            case sao_enterRewardMap2: {
                    c.getSession().write(CField.showMapEffect("Sao/Start2"));
                 break;
            }
            ...
            case enter_101070000: {
                ...
                c.getSession().write(CField.showMapEffect("temaD/enter/fairyAcademy"));
                break;
            }
            ...
            case evolvingDirection1: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CField.showMapEffect("evolving/mapname"));
                    Thread.sleep(4000);
            ...
            case evolvingDirection2: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CField.showMapEffect("evolving/swoo1"));
                ...
                break;
                 ...
                 //   c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                //    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CField.showMapEffect("evolving/swoo2"));
                    Thread.sleep(4000);
            ...
            case q2614M:
                ...
                break;
            case Resi_tutor20:
                c.getSession().write(CField.showMapEffect("resistance/tutorialGuide"));
                break;
            case Resi_tutor30:
            ...
            case np_tuto_0_5: {
                ...
                c.getSession().write(UIPacket.IntroEnableUI(1));
                c.getSession().write(CField.showMapEffect("phantom/back"));
                c.getSession().write(UIPacket.getDirectionInfo(3, 4));
                c.getSession().write(CField.showMapEffect("newPirate/Shuttle/0"));
                try {
                    Thread.sleep(6000);
                } catch (InterruptedException e) {
                ...
                c.getSession().write(CField.showMapEffect("phantom/back"));
                c.getSession().write(CField.showMapEffect("newPirate/TimeTravel/0"));
                try {
                    Thread.sleep(5000);
                } catch (InterruptedException e) {
                    System.out.println("" + e.toString());
                }
                c.getSession().write(CField.showMapEffect("newPirate/text1"));
                try {
                    Thread.sleep(2000);
                } catch (InterruptedException e) {
                    System.out.println("" + e.toString());
...
//                c.getPlayer().setDirection(0);
            ...
            case mPark_stageEff:
                ...
                switch ((c.getPlayer().getMapId() % 1000) / 100) {
                    ...
                    case 2:
                    case 3:
                        c.getSession().write(CField.showMapEffect("monsterPark/stageEff/stage"));
                        c.getSession().write(CField.showMapEffect("monsterPark/stageEff/number/" + (((c.getPlayer().getMapId() % 1000) / 100) + 1)));
                        break;
                    case 4:
                        if (c.getPlayer().getMapId() / 1000000 == 952) {
                            c.getSession().write(CField.showMapEffect("monsterPark/stageEff/final"));
                        } else {
                            c.getSession().write(CField.showMapEffect("monsterPark/stageEff/stage"));
                            c.getSession().write(CField.showMapEffect("monsterPark/stageEff/number/5"));
                        }
                        break;
                    case 5:
                        c.getSession().write(CField.showMapEffect("monsterPark/stageEff/final"));
            ...
            case TD_MC_title: {
                ...
                c.getSession().write(UIPacket.IntroLock(false));
                c.getSession().write(CWvsContext.enableActions());
                c.getSession().write(CField.showMapEffect("temaD/enter/mushCatle"));
                break;
            }
            case TD_NC_title: {
                switch ((c.getPlayer().getMapId() / 100) % 10) {
                    case 0:
                        c.getSession().write(CField.showMapEffect("temaD/enter/teraForest"));
                        break;
                    case 1:
                    case 2:
                    case 3:
                    ...
                    case 5:
                    case 6:
                        c.getSession().write(CField.showMapEffect("temaD/enter/neoCity" + ((c.getPlayer().getMapId() / 100) % 10)));
                        break;
                }
                break;
            }
            case explorationPoint: {
                if (c.getPlayer().getMapId() == 104000000) {
                    c.getSession().write(CField.showEnterEffect("maplemap/enter/104000000"));
                    c.getSession().write(UIPacket.IntroDisableUI(false));
                    c.getSession().write(UIPacket.IntroLock(false));
                    c.getSession().write(CWvsContext.enableActions());
                }
            ...
            */
            ...
            case np_tuto_0_0_before: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CField.showEnterEffect("newPirate/text0"));
          ...
          //      c.getSession().write(CField.UIPacket.IntroDisableUI(true));
            ...
            case PTtutor000: {
                try {
                    ...
                    Thread.sleep(85000);
                    c.getSession().write(CField.showMapEffect("phantom/mapname1"));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 3, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 3, 0));
            ...
            case PTtutor300: {
                c.getSession().write(CField.showMapEffect("phantom/mapname2"));
            ...
            case PTtutor500: {
                c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                try {
                    c.getSession().write(CField.showMapEffect("phantom/mapname3"));
                    Thread.sleep(3000);
                } catch (InterruptedException ex) {
                }
                NPCScriptManager.getInstance().dispose(c);
            ...
            case go10000:
                ...
                break;
            case go20000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/20000"));
                ...
                break;
            case go30000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/30000"));
                break;
            case go40000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/40000"));
                break;
            case go50000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/50000"));
                break;
            case go1000000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1000000"));
                break;
            case go1010000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1010000"));
                break;
            case go1010100:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1010100"));
                break;
            case go1010200:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1010200"));
                break;
            case go1010300:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1010300"));
                break;
            case go1010400:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1010400"));
                break;
            case go1020000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/1020000"));
                c.getSession().write(UIPacket.IntroDisableUI(false));
                c.getSession().write(UIPacket.IntroLock(false));
                c.getSession().write(CWvsContext.enableActions());
                break;
            case go2000000:
                c.getSession().write(CField.showEnterEffect("maplemap/enter/2000000"));
                break;
                ...
                if (c.getPlayer().getQuestStatus(25111) == 1) {
                    ...
                    while (true) {
                        ...
                        if (c.getPlayer().getJob() == 2410) {
                            ...
                            c.getSession().write(CField.showMapEffect("phantom/suu"));
                            c.removeClickedNPC();
                            NPCScriptManager.getInstance().dispose(c);
                            c.getSession().write(CWvsContext.enableActions());
                            break;
                        ...
                        public void run() {
                            ...
                            while (true) {
                                ...
                                if (c.getPlayer().getJob() == 2411 && c.getPlayer().getPosition().y == -30) {
                                    ...
                                    c.getSession().write(CField.showMapEffect("phantom/darkphantom"));
                                    break;
                                }
                                try {
                                    Thread.sleep(500);
            ...
            case ds_tuto_2_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.getSession().write(UIPacket.getDirectionInfo(3, 0));
                        c.getSession().write(CField.showMapEffect("demonSlayer/text13"));
            ...
            case ds_tuto_1_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.getSession().write(UIPacket.getDirectionInfo(3, 0));
                        c.getSession().write(CField.showMapEffect("demonSlayer/text8"));
                        c.getSession().write(UIPacket.getDirectionInfo(1, 500));
                    }
                }, 1000);
                EventTimer.getInstance().schedule(new Runnable() {
            ...
            case ds_tuto_0_0: {
                ...
                c.getPlayer().changeSkillsLevel(sa);
                c.getSession().write(UIPacket.getDirectionInfo(3, 0));
                c.getSession().write(CField.showMapEffect("demonSlayer/back"));
                c.getSession().write(CField.showMapEffect("demonSlayer/text0"));
                c.getSession().write(UIPacket.getDirectionInfo(1, 500));
                c.getPlayer().setDirection(0);
                if (!c.getPlayer().getMap().containsNPC(2159307)) {
            ...
            case azwan_stageEff: {
                ...
                switch ((c.getPlayer().getMapId() % 1000) / 100) {
                    ...
                    case 2:
                    case 3:
                        c.getSession().write(CField.showMapEffect("aswan/stageEff/stage"));
                        c.getSession().write(CField.showMapEffect("aswan/stageEff/number/" + (((c.getPlayer().getMapId() % 1000) / 100))));
                        break;
                }
            ...
            case Massacre_result: { //clear, give exp, etc.
                //if (c.getPlayer().getPyramidSubway() == null) {
                c.getSession().write(CField.showMapEffect("killing/fail"));
                //} else {
            ...
            case hayatoJobChange: {
                ...
                while (c.getPlayer().getLevel() < 10) {
                    c.getSession().write(CField.showMapEffect("JPKanna/text0"));
                    c.getSession().write(CField.showMapEffect("JPKanna/text1"));
                    c.getSession().write(CField.showMapEffect("JPKanna/text2"));
                    c.getPlayer().levelUp();
                    c.getPlayer().levelUp();
                    c.getPlayer().levelUp();
                    c.getPlayer().levelUp();
    ...
    private static void sendDojoStart(MapleClient c, int stage) {
        ...
        c.getSession().write(CField.playSound("Dojang/start"));
        c.getSession().write(CField.showEnterEffect("dojang/start/stage"));
        c.getSession().write(CField.showEnterEffect("dojang/start/number/" + stage));
                ...
                for (String s : di.eventQ) {
                    switch (directionInfo.fromString(s)) {
                        ...
                        case merTutorDrecotion21:
                            ...
                            break;
                        case ds_tuto_0_2:
                            c.getSession().write(CField.showMapEffect("demonSlayer/text1"));
                            break;
                        case ds_tuto_0_1:
                            c.getSession().write(UIPacket.getDirectionInfo(3, 2));
                            break;
